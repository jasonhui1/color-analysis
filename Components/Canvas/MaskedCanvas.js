...
const MaskedCanvas = ({ canvasRef, image, reset = true, maskMode = false, maskImage = null, setDrawingComplete = null, initialColor = 'black' }) => {
    ...
    useEffect(() => {
        if (image && canvasRef.current) {
            ...
            if (setDrawingComplete) setDrawingComplete(true)
        }
